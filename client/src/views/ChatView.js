...
import {
    addMessage, addMessageId, clearMessageIds, clearMessages, disconnectConversation,
    hideLoader, showLoader, startNewConversation,
    updateCommonInterests, updateCurrentMessage, updateDisconnectedMessage,
    updatePartnerSocketId, updateShowConfirmButton, updateShowLoadingButton, updateShowRefreshButton,
    updateStatus
            ...
            <ThemeProvider theme={theme}>
                ...
                <Grid container spacing={2} sx={{flexGrow: 1}}>
                    <Grid item sx={{width: "100%", ml: "5%", mr: "5%"}}>
                        <StyledPaper sx={{padding: "10px", width:"100%", height: "70vh", mt: "1%", overflow: 'scroll'}}>
